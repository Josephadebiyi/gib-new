...
import { Clock, Users, Award, CheckCircle, ArrowRight, Target, Shield, Download, Calendar, Euro, Phone, Key } from 'lucide-react'
              ...
              <div className="space-y-6">
                ...
                <Card className="border-l-4 border-l-[#173104] shadow-sm">
                  <CardContent className="p-6">
                    ...
                    <p className="text-2xl font-bold text-[#173104]">€1,730</p>
                    <p className="text-sm text-gray-600">
                      €1,250 course fee + €50 registration + €430 CIAM certification fee
                    </p>
