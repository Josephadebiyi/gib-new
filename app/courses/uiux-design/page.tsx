...
import { Clock, Users, Award, CheckCircle, ArrowRight, Target, Palette, Download, Calendar, Euro, Phone, Figma } from 'lucide-react'
                ...
                <Card className="border-l-4 border-l-[#173104] shadow-sm">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-gray-600">
                      €1,250 course fee + €50 registration + €290 Google UX certification fee
                    </p>
